...
public class PrincipalServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(tipoEndereco[0].equals("forward")) { // verifica se na posição 0 do array tipoEEndereco tem "foward", se sim entra no if
	        RequestDispatcher rd = request.getRequestDispatcher("WEB-INF/view/" + tipoEndereco[1]); // chama o método getRequestDispatcher passando como parâmetro a posição 1 do array que contém o valor "listaEmpresa"
